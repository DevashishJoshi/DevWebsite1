...
<body>
    ...
    $d="SELECT DoctorID FROM doctor WHERE Email='$email'";
    $result=mysqli_query($con,$d) or die ("failed to query");
    $row=mysqli_fetch_array($result);
    $did=$row['DoctorID'];
    $sql="SELECT Name, Email, PhoneNo, Date_Time FROM appointment NATURAL JOIN patient WHERE DoctorID='$did';"
