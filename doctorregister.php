            ...
            if(isset($_POST['email']) && isset($_POST['password'])) {
                ...
                if(!empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['fullname'])) {
                    ...
                    if($row['Email'] == $email1) {
                        ...
                        $sql = "INSERT INTO doctor_login VALUES ('$name','$email1','$password1')";
                                ...
                                <div class="form-bottom">
                                    <form role="form" action="<?php 'doctorregister.php'; ?>" method="post" class="registration-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gender" placeholder="M/F" class="form-email form-control" id="form-email">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="form-mbnumber">Mobile Number</label>
                                            <input type="text" name="mbnumber" placeholder="Mobile Number..." class="form-email form-control" id="form-email">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="sr-only" for="form-email">Quali</label>
                                            <input type="text" name="email" placeholder="Email..." class="form-email form-control" id="form-email">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="form-email">Email</label>
