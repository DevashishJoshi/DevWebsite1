  ...
  <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
          <div class="container-fluid text-center">
           ...
           <p>
            <label class=" col-sm-3" >Qualification:</label><?php echo $qualification;?><br>
           </p>
           <p>
            <label class=" col-sm-3" >Specialization:</label><?php echo $specialization;?><br>
           </p>
           <p>
           ...
           <p>
            <label class=" col-sm-3" >DoctorID:</label><?php echo $doctorid;?><br>
           </p>
